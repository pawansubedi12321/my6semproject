...
<td scope='col' className='text-start'>  <CFormCheck id="flexCheckDefault"/></td>
  <td scope='col' className='salesreturn text-start'>1</td>
  <td scope='col' className='salesreturn text-start'>Product A</td>
  <td scope='col' className='salesreturn text-start'>123456789012</td>
  <td scope='col' className='salesreturn text-start'>1000</td>
  <td scope='col' className='salesreturn text-start'>10</td>
  <td scope='col' className='salesreturn text-start'>Rs. 10000</td>
  <td scope='col' className='salesreturn text-start'>Supplier X</td>
  <td scope='col' className='salesreturn text-start'>High-quality product for daily use</td>
  <td scope='col' className='salesreturn text-start'></td>
</tr>
